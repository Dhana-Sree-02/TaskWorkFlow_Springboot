...
import taskflow.service.UsersService;
...
public class UsersController {
	...
	@PostMapping("/adduser")
	public Object addUser(@RequestBody Users U)
	{
		return US.addUser(U);
	}

	@PutMapping("/edituser/{id}")
	public Object editUser(@PathVariable("id") Long id, @RequestBody Users U)
	{
		return US.editUser(id, U);
	}
